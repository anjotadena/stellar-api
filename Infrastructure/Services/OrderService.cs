...
namespace Infrastructure.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<Order?> CreateOrderAsync(string email, int paymentMethodId, string cartId, Core.Entities.OrderAggregate.Address address)
        {
            ...
            {
                order = new Order(items, email, address, deliveryMethod, subtotal, basket.PaymentIntentId);
        ...
        {
             var spec = new OrderWithItemAndOrderingSpecification(id, email);
        ...
        {
            var spec = new OrderWithItemAndOrderingSpecification(email);
